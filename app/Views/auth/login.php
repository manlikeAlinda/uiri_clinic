      ...
      <form action="<?= base_url('login/authenticate') ?>" method="post" novalidate>
        ...
        <div class="icon-field mb-16">
          ...
          <input type="text" name="username" class="form-control h-56-px bg-neutral-50 radius-12"
            placeholder="Username" required autocomplete="username" spellcheck="false">
        </div>
        ...
        <div class="position-relative mb-20">
          ...
          <button type="button" class="toggle-password ri-eye-line cursor-pointer position-absolute end-0 top-50 translate-middle-y me-16 text-secondary-light"
            data-toggle="#your-password" aria-pressed="false" aria-label="Show password"></button>
        </div>
