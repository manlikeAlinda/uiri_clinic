          ...
          <div class="dropdown-menu to-top dropdown-menu-sm">
            ...
            <ul class="to-top-list">
              <li>
                <a
                  href="<?= base_url('users') ?>"
                  class="dropdown-item text-black px-0 py-2 d-flex align-items-center gap-3
      <?= service('uri')->getSegment(1) === 'users' ? 'hover-text-primary bg-light' : 'hover-bg-transparent' ?>">
