        ...
        <div class="dropdown">
          ...
          <div class="dropdown-menu to-top dropdown-menu-sm">
            <div class="py-12 px-16 radius-8 bg-primary-50 mb-16 d-flex align-items-center justify-content-between gap-2">
              <div>
                <h6 class="text-lg text-primary-light fw-semibold mb-2">Welcome, <?= session('user_name') ?></h6>
            ...
            <ul class="to-top-list">
              <li>
                ...
                <iconify-icon icon="solar:user-linear" class="icon text-xl"></iconify-icon>Manage Users</a>
              </li>
              <li>
                ...
                <iconify-icon icon="icon-park-outline:setting-two" class="icon text-xl"></iconify-icon> Profile Settings</a>
              </li>
              <li>
